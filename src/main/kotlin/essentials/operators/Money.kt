...
data class Money(
    ...
    operator fun plus(other: Money): Money {
        if (this.currency != other.currency) {
            throw IllegalArgumentException("Currency is not the same as $this")
        }
    ...
    operator fun times(scalar: Number): Money {
        return Money(amount * BigDecimal.valueOf(scalar.toLong()), currency)
    }
